...
evaluate_model("Improved Logistic Regression", lr_model, X_test_scaled, y_test)
...
evaluate_model("Improved Random Forest", rf_model, X_test, y_test)
...
evaluate_model("Improved XGBoost", xgb_model, X_test, y_test)
